    ...
    try:
        ...
        response = emr_client.run_job_flow(
            ...
            Instances={
                ...
                'Ec2KeyName': 'emr-sparkle-windows-v2',
            ...
            Steps=[
                {
                    'Name': 'sparkle-v9',
                    'ActionOnFailure': 'TERMINATE_CLUSTER',  # TERMINATE_CLUSTER | CANCEL_AND_WAIT | CONTINUE
                    'HadoopJarStep': {
                        'Jar': 'command-runner.jar',
                        'Args': [
                            'spark-submit',
                            '--deploy-mode', 'cluster',
                            's3://spark-preprocessing-test-0000/spark-apps/sparkle-v9.py',
                            '--input_directory', 's3://spark-preprocessing-test-0000/test-raw-data/',
                            '--output_directory', 's3://spark-preprocessing-test-0000/processed-data-v8/',
                ...
                },
                {
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': [
                            'bash', '-c', 
                            'aws glue start-crawler --name crawler-v8-2'
                        ]
                    }
                }
            ],
